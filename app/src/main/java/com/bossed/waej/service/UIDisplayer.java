...
public class UIDisplayer {
    ...
    /* 必须在UI线程中初始化handler */
    public UIDisplayer(ImageView imageView, ProgressBar bar, Activity activity) {
            ...
            public void handleMessage(Message inputMessage) {
                ...
                switch (inputMessage.what) {
                    ...
                    case DOWNLOAD_OK:
                        ...
                        break;
                    case SETTING_OK:
                        new AlertDialog.Builder(UIDisplayer.this.activity).setTitle("设置成功").setMessage("设置域名信息成功,现在<选择图片>,\n 然后上传图片").show();
                        break;
                    case DOWNLOAD_FAIL:
                        info = (String) inputMessage.obj;
