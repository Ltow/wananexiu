...
public class OssManager {
    ...
    public OssManager(OSS oss, String bucket, UIDisplayer uiDisplayer) {
        this.mOss = oss;
        this.mBucket = bucket;
        this.mDisplayer = uiDisplayer;
    }

    public OssManager(OSS oss, String bucket) {
        this.mOss = oss;
        this.mBucket = bucket;
    }
    ...
    public void asyncResumableDownload(String downloadPath, String BUCKET_NAME) {
        Map<String, String> header = new HashMap<>();
        ResumableDownloadRequest request = new ResumableDownloadRequest(BUCKET_NAME, "landscape-painting1.jpeg", downloadPath + "/landscape-painting.jpeg");
...
//        request.setRange(new Range(0, 1024 * 1024));
    ...
    public void customSign(Context ctx, String objectKey, String OSS_ACCESS_KEY_ID, String OSS_ACCESS_KEY_SECRET) {
