...
class PopWindow private constructor(val context: Context) : PopupWindow() {
    ...
    private fun showAsDropDown(anchor: View?, xoff: Int, yoff: Int, block: (() -> Unit)? = null) {
        try {
    ...
    class Builder(context: Context) {
        private lateinit var listener: (contentView: View,  pop: PopupWindow) -> Unit
         ...
         */
        fun setChildrenView(listener: (contentView: View,  pop: PopupWindow) -> Unit): Builder {
        ...
        fun create(): PopWindow {
            ...
            if (listener != null && popView != null) {
                listener.invoke(popView, popupWindow)
            }
