...
class PurchaseHistoryInfoAdapter(mutableList: MutableList<PartListRow>) :
    ...
    override fun convert(helper: BaseViewHolder, item: PartListRow) {
        helper.setText(R.id.tv_name, item.name)
            ...
            .setText(R.id.tv_num_name, "进货数量：")
            .setText(R.id.tv_price_name, "进货单价：")
            .setText(R.id.tv_money_name, "进货小计：")
    }
}