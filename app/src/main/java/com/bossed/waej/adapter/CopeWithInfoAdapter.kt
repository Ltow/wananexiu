...
class CopeWithInfoAdapter(data: MutableList<SupplierBillRow>) :
    BaseQuickAdapter<SupplierBillRow, BaseViewHolder>(
        R.layout.layout_item_cope_with_info, data
    ) {
    override fun convert(helper: BaseViewHolder, item: SupplierBillRow) {
