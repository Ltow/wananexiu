 ...
 * 配件选择器--带库存
 */
class SelectPartActivity3 : BaseActivity(), View.OnClickListener, OnRefreshLoadMoreListener {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        adapter = SelectPartAdapter(list, 2)
    ...
    override fun initListener() {
        ...
        tb_sel_part.setOnTitleBarListener(object : OnTitleBarListener {
            ...
            override fun onRightClick(view: View?) {
                val intent = Intent(this@SelectPartActivity3, PartActivity::class.java)
