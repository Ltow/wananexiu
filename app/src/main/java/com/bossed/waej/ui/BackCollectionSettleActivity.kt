...
import kotlinx.android.synthetic.main.activity_collection_settle.et_discount
import kotlinx.android.synthetic.main.activity_collection_settle.et_remark
import kotlinx.android.synthetic.main.activity_collection_settle.rv_collection_settle
import kotlinx.android.synthetic.main.activity_collection_settle.tb_collection_settle
import kotlinx.android.synthetic.main.activity_collection_settle.tv_date_sel
import kotlinx.android.synthetic.main.activity_collection_settle.tv_moneyOwe
import kotlinx.android.synthetic.main.activity_collection_settle.tv_money_total
import org.greenrobot.eventbus.EventBus
import java.math.BigDecimal

class BackCollectionSettleActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun collection(accountList: ArrayList<HashMap<String, Any>>) {
        ...
        params["discount"] =
            if (TextUtils.isEmpty(et_discount.text.toString())) 0.0 else et_discount.text.toString()
        params["type"] = "1"
        params["returnOrder"] = "1"
        LoadingUtils.showLoading(this, "加载中...")
        RetrofitUtils.get()
            .postJson(
                UrlConstants.PaymentUrl, params, this,
