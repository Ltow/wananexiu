...
import kotlinx.android.synthetic.main.fragment_shang_jia.rv_pic
import kotlinx.android.synthetic.main.fragment_shang_jia.rv_worker

class SJFragment2 : BaseFragment() {
    ...
    override fun initView(view: View?, savedInstanceState: Bundle?) {
        ...
        workers.add("李四")
        workers.add("王五")
        workerAdapter = WorkerAdapter(workers,2)
