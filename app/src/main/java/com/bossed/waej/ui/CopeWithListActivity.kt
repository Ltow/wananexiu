...
import com.bossed.waej.http.UrlConstants.CopeWithListUrl
 ...
 * 应付账款总览
 */
class CopeWithListActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        copeWithListAdapter = CopeWithListAdapter(copeList, 1)
    ...
    override fun initListener() {
        ...
        copeWithListAdapter.setOnItemClickListener { adapter, view, position ->
            val intent = Intent(this, CopeWithInfoActivity::class.java)
    ...
    private fun getList() {
        ...
        RetrofitUtils.get()
            .getJson(CopeWithListUrl, params, this, object : RetrofitUtils.OnCallBackListener {
